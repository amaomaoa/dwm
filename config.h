...
static const char buttonbar[]       = "「〇」";
//static const char buttonbar[]       = "「零」";
static const char *fonts[]          = { "SourceCodePro-BlackIt Mono:size=10" };
static const char dmenufont[]       = "SourceCodePro-BlackIt Mono:size=10";
...
static Key keys[] = {
	...
	{ Mod4Mask,                     XK_g,      spawn,          {.v = chromecmd } },
	{ MODKEY|Mod4Mask,              XK_s,      spawn,          SHCMD("transset-df -a --dec .1") },
	{ MODKEY|Mod4Mask,              XK_d,      spawn,          SHCMD("transset-df -a --inc .1") },
	{ MODKEY|Mod4Mask,              XK_f,      spawn,          SHCMD("transset-df -a .75") },
